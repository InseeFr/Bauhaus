...
export const LOAD_DISSEMINATION_STATUS_LIST_FAILURE = 'LOAD_DISSEMINATION_STATUS_LIST_FAILURE'
import { getDisseminationStatusList } from '../utils/remote-api'

export const loadDisseminationStatusList = () =>
  (dispatch, getState) => {
    dispatch({
    ...
    return getDisseminationStatusList()
      .then(disseminationStatusList => dispatch(loadDisseminationStatusListSuccess(disseminationStatusList.disseminationStatus)))
