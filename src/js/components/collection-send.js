...
class CollectionSend extends Component {
  ...
  constructor(props) {
    ...
    var params = [this.props.collectionGeneral.prefLabelFr, this.props.collectionGeneral.id]
    ...
    this.state = {
      ...
      object: dictionary.collection.send.object.value([this.props.collectionGeneral.prefLabelFr]),
          ...
          <div className='container'>
            <div className='row centered'>
              <div className='col-md-12'>
                {creation === 'DONE' && <h2>{dictionary.collection.send.success([collectionGeneral.prefLabelFr])}</h2>}
                {creation === 'FAILED' && <h2>{dictionary.collection.send.failed([collectionGeneral.prefLabelFr])}</h2>}
              </div>
            </div>
            <div className='row'>
              <div className='col-md-12'>
    ...
    return (
      <div>
        ...
        <div className='container'>
          <div className="row">
            <div className='col-md-10 centered col-md-offset-1'>
              <h2 className="page-title">
                {dictionary.collection.send.title([collectionGeneral.prefLabelFr])}
              </h2>
            </div>
          </div>
          ...
          <div className="form-group">
            <label>{dictionary.collection.send.object.title}</label>
