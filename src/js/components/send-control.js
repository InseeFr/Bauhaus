  ...
  render() {
    ...
    return (
      <div className='row btn-line'>
        ...
        <div className='col-md-2'>
          <button type="button" className="btn btn-primary btn-lg col-md-12 pull-right" disabled>
    ...
    return (
      <div className='row btn-line'>
        ...
        <div className='col-md-2 pull-right'>
          <button type="button" className="btn btn-primary btn-lg col-md-12" onClick={onChange}>
            {dictionary.buttons.send}
          </button>
        </div>
      </div>
