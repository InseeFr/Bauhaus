...
class ConceptCreateControl extends Component {
  render() {
    ...
    if (
      _.includes(attr.disseminationStatus, 'Public') &&
      !attr.isDefinitionCourteFr
    ) {
      return (
        <div className="row btn-line">
          <div className="col-md-2">
    ...
    if (
      editorLength(attr.definitionCourteFr) > maxLengthScopeNote ||
      editorLength(attr.definitionCourteEn) > maxLengthScopeNote
    ) {
      return (
        <div className="row btn-line">
          <div className="col-md-2">
    ...
    if (
      attr.prefLabelFr &&
      attr.creator &&
      attr.disseminationStatus &&
      !attr.isLabelFrExisting &&
      attr.isDefinitionFr
    ) {
      return (
        <div className="row btn-line">
