...
import { sortArray, filterByPrefLabelFr, arrayKeepUniqueField } from '../utils/array-utils'
...
class ConceptCreate extends Component {
  ...
  render() {
    ...
    const { contributor, creator, potentialMembers, searchLabel, dateEnd, disseminationStatus,
        ...
        <div className="container">
          <div className="row">
            <div className='col-md-10 centered col-md-offset-1'>
              <h2 className="page-title">{dictionary.concept.create}</h2>
            </div>
          </div>
          <ConceptCreateControl attr={this.state} onChangeSave={this.editConceptData} onChangeReturn={this.return}/>
          <ul className="nav nav-tabs nav-justified">
            <Tabs activeKey={this.state.activeTab} id='tab'>
              <Tab eventKey={1} title={dictionary.concept.general}>
                ...
                <div className='row'>
                  <div className="form-group col-md-6">
                    ...
                    <input type="text" className="form-control" onChange={e => this.handleChangePrefLabelFr(e.target.value)} />
                  </div>
                  <div className="form-group col-md-6">
                    <label>{dictionary.concept.label} ( {flagEn} ) <span className='boldWhite'>*</span></label>
                    <input type="text" className="form-control" onChange={e => this.handleChangePrefLabelEn(e.target.value)} />
                  </div>
                </div>
                <div className='row'>
                  <div className="form-group col-md-6">
                    <label>{dictionary.concept.altLabel} ( {flagFr} )</label>
                    <input type="text" className="form-control" onChange={e => this.handleChangeAltLabelFr(e.target.value)} />
                  </div>
                  <div className="form-group col-md-6">
                    <label>{dictionary.concept.altLabel} ( {flagEn} )</label>
                    <input type="text" className="form-control" onChange={e => this.handleChangeAltLabelEn(e.target.value)} />
                  </div>
                </div>
                ...
                <div className="form-group">
                  ...
                  <input type="text" className="form-control" defaultValue={contributor} disabled />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <div className="input-group">
                    ...
                    <input type="text" className="form-control" onChange={e => this.handleChangeAdditionnalMaterial(e.target.value)} />
                  </div>
                </div>
                <div className="form-group">
              ...
              <Tab eventKey={2} title={dictionary.notes.title}>
                <ul className="nav nav-tabs nav-justified">
                  <Tabs defaultActiveKey={1} activeKey={this.state.activeTab} id='tab2' onSelect={this.handleSelectTab}>
                    <Tab eventKey={1} title={scopeNoteTabLabel} style={{'margin-top': '20px'}}>
                      <div className='row'>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagFr}</label>
                            <EditorHtml editor={definitionCourteFr} onEditorChange={e => this.changeDefinitionCourteFr(e)} />
                        ...
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagEn}</label>
                            <EditorHtml editor={definitionCourteEn} onEditorChange={e => this.changeDefinitionCourteEn(e)} />
                    ...
                    <Tab eventKey={2} title={definitionTabLabel} style={{'margin-top': '20px'}}>
                      <div className='row'>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagFr}</label>
                            <EditorHtml editor={definitionFr} onEditorChange={e => this.changeDefinitionFr(e)} />
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagEn}</label>
                            <EditorHtml editor={definitionEn} onEditorChange={e => this.changeDefinitionEn(e)} />
                          </div>
                        </div>
                      </div>
                    </Tab>
                    <Tab eventKey={3} title={dictionary.notes.editorialeNote} style={{'margin-top': '20px'}}>
                      <div className='row'>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagFr}</label>
                            <EditorHtml editor={noteEditorialeFr} onEditorChange={e => this.changeNoteEditorialeFr(e)} />
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagEn}</label>
                            <EditorHtml editor={noteEditorialeEn} onEditorChange={e => this.changeNoteEditorialeEn(e)} />
                          </div>
                        </div>
                      </div>
                    </Tab>
                    <Tab eventKey={4} title={dictionary.notes.changeNote} style={{'margin-top': '20px'}}>
                      <div className='row'>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagFr}</label>
                            <EditorHtml editor={changeNoteFr} onEditorChange={e => this.changeChangeNoteFr(e)} />
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className="form-group centered">
                            <label>{flagEn}</label>
                            <EditorHtml editor={changeNoteEn} onEditorChange={e => this.changeChangeNoteEn(e)} />
                          </div>
                        </div>
                      </div>
                    </Tab>
              ...
              <Tab eventKey={3} title={dictionary.links.title}>
                <ul className="nav nav-tabs nav-justified">
                  <Tabs defaultActiveKey={1} activeKey={this.state.activeTab} id='tab2' onSelect={this.handleSelectTab}>
                    <Tab eventKey={1} title={dictionary.links.narrower} style={{'margin-top': '20px'}}>
                    ...
                    <Tab eventKey={2} title={dictionary.links.broader} style={{'margin-top': '20px'}}>
                      <ConceptToLink panelTitle={dictionary.links.broader} memberList={memberEnfantsList}
                      potentialMembersList={potentialMembersList} searchLabel={searchLabel} onChange={e => this.handleChangeSearch(e.target.value)}/>
                    </Tab>
                    <Tab eventKey={3} title={dictionary.links.references} style={{'margin-top': '20px'}}>
                      <ConceptToLink panelTitle={dictionary.links.references} memberList={memberRefList}
                      potentialMembersList={potentialMembersList} searchLabel={searchLabel} onChange={e => this.handleChangeSearch(e.target.value)}/>
                    </Tab>
                    <Tab eventKey={4} title={dictionary.links.replaces} style={{'margin-top': '20px'}}>
                      <ConceptToLink panelTitle={dictionary.links.replaces} memberList={memberSucceedList}
                      potentialMembersList={potentialMembersList} searchLabel={searchLabel} onChange={e => this.handleChangeSearch(e.target.value)}/>
                    </Tab>
                    <Tab eventKey={5} title={dictionary.links.related} style={{'margin-top': '20px'}}>
