...
import { loadConceptsList, loadConceptsToValidateList } from '../actions/concepts-list';
      ...
      <div>
        <div className="row form-group">
          <div className='col-md-12'>
            <input value={searchLabel} onChange={e => this.handleChangeSearchLabel(e.target.value)} type='text' placeholder={dictionary.concepts.searchLabel} className='form-control'/>
          </div>
        </div>
        <div className="row">
          <div className="col-md-12">
            <Link to={'/concepts/search'}>
              <h3 className="glyphicon glyphicon-zoom-in inline"></h3><h3 className="inline"> {dictionary.concepts.advancedSearch}</h3>
            </Link>
          </div>
        </div>
        <div className="row">
