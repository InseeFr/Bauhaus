...
import { creatSelectList, creatSelectListSelectedLast } from '../utils/array-utils'
        ...
        <div className="container">
          ...
          <div className='row'>
            <div className='col-md-10 centered col-md-offset-1'>
              { !english && <h2 className="page-title">{conceptGeneral.prefLabelFr}</h2> }
              { english && <h2 className="page-title"><em>{conceptGeneral.prefLabelEn} </em></h2> }
            </div>
          </div>
          <div className="row btn-line">
            <div className='col-md-3'>
              <button className="btn btn-primary btn-lg col-md-12" onClick={this.handleClick}>
          ...
          <div className='row'>
            <div className='col-md-6 centered'>
              <h3> {dictionary.concept.version} : <select defaultValue={conceptGeneral.conceptVersion-1} onChange={e => this.changeSelect1(e)}>
                                {creatSelectList(conceptGeneral.conceptVersion)}</select>
              </h3>
            </div>
            <div className='col-md-6 centered'>
              <h3> {dictionary.concept.version} : <select defaultValue={conceptGeneral.conceptVersion} onChange={e => this.changeSelect2(e)}>
                                {creatSelectListSelectedLast(conceptGeneral.conceptVersion)}</select>
              </h3>
            </div>
          <ConceptCompareNotes english={english} conceptGeneral={conceptGeneral} version1={this.state.select1} version2={this.state.select2} />
          </div>
        </div>
      </div>
    )}
