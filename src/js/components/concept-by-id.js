        ...
        <div className="container">
          ...
          <div className='row'>
            <div className='col-md-10 centered col-md-offset-1'>
              <h2 className="page-title">{conceptGeneral.prefLabelFr}</h2>
            </div>
          </div>
          <ConceptByIDButtons attr={conceptGeneral} onClickReturn={this.handleClickReturn}
                              onClickSend={this.handleClickSend} onClickCompare={this.handleClickCompare}
                              onClickModif={this.handleClickModif} onClickValid={this.handleClickValid} />
          { english && <div className='row'>
            <div className='col-md-10 centered col-md-offset-1'>
              <h2>
                <em>{conceptGeneral.prefLabelEn}</em>
              </h2>
            </div>
          </div> }
          <ConceptGeneral attr={conceptGeneral} english={english}/>
          {conceptLinks.length>0 && <ConceptLinks english={english} links={conceptLinks}/>}
          {conceptNotes[conceptGeneral.conceptVersion] && <ConceptNotes english={english} attr={conceptNotes[conceptGeneral.conceptVersion]}/>}
        </div>
      </div>
  )}
}
