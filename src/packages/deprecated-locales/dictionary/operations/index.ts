...
const dictionary = {
  ...
  essentialRubricMsgPlural: {
    ...
    en: (nb: number, total: number) => `You have completed ${nb} out of ${total} essential items.`,
  },
  essentialRubricMsg: {
    fr: (_nb: string, total: number) => `Vous avez rempli 1 rubrique essentielle sur ${total}`,
    en: (_nb: string, total: number) => `You have completed 1 out of ${total} essential items.`,
  },
  essentialRubricKo: {
