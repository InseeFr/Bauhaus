...
/** Formulaire d'édition d'une liste de codes : plus riche que le modèle `Codelist`
 * (dédié à l'écran des codes), il porte les métadonnées de la fiche. */
interface CodelistFormValues {
  id?: string;
  labelLg1?: string;
  labelLg2?: string;
  descriptionLg1?: string;
  descriptionLg2?: string;
  lastListUriSegment?: string;
  lastCodeUriSegment?: string;
  lastClassUriSegment?: string;
  creator?: string;
  contributor?: string[];
...
interface CodelistDetailEditTypes {
  codelist: CodelistFormValues;
  handleSave: (codelist: CodelistFormValues) => void;
      ...
      <form>
        ...
        <div className="form-group">
          <ContributorsInput
            ...
            onChange={(values) => {
              setCodelist({ ...codelist, contributor: values as string[] });
            }}
          />
        </div>
        <div className="form-group">
