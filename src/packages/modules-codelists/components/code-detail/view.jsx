  ...
  return (
    <>
          ...
          text={
            <ul>
              {codesOptions
                .filter(
                  ({ value }) =>
                    code.parents && code.parents.some((parent) => parent.code === value),
                )
                .map((code) => (
      ...
      <Row>
        ...
        {secondLang && <Note text={code.labelLg2} title={D2.codeLabel} alone={false} />}
      </Row>
      <Row>
        <Note
          text={descriptionLg1}
        ...
        />
        {secondLang && (
          <Note text={descriptionLg2} title={D2.codeDescription} alone={false} allowEmpty={true} />
        )}
      </Row>
    </>
  );
