...
export const validateCodelist = (codelist) => formatValidation(ZodCodeList)(codelist);
...
export const validatePartialCodelist = (codelist) => formatValidation(ZodPartialCodeList)(codelist);
    ...
    .reduce((acc, c) => {
      return [
        ...acc,
        {
          ...
          label: c.labelLg1,
          isPartial:
            childCl.filter((partial) => partial.code === c.code && partial.parent === c.parent)
              .length > 0,
        },
      ];
    }, []);
