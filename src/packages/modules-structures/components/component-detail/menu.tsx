...
export const ViewMenu = ({
  ...
  return (
    <ActionToolbar>
      ...
      <HasAccess module="STRUCTURE_COMPONENT" privilege="PUBLISH" stamps={component?.contributor}>
      ...
      {updatable && (
        <HasAccess module="STRUCTURE_COMPONENT" privilege="UPDATE" stamps={component?.contributor}>
