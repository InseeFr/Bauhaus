import { buildCollectionPayload } from "./buildCollectionPayload";
...
describe("buildCollectionPayload", () => {
  it("CREATE", () => {
    const output = buildCollectionPayload(collection, "CREATE");
  ...
  it("UPDATE", () => {
    const output = buildCollectionPayload(collection, "UPDATE");
    expect(output).toEqual({
      id: "id",
      created: "created",
      creator: "creator",
