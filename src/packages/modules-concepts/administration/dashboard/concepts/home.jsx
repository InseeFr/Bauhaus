...
function ConceptsDashboard({ conceptsData, collectionsData }) {
  ...
  const tabsConcepts = [
    ...
    },
    {
      ...
      content: <ConceptsCreationsModifications conceptsData={conceptsData} type="creations" />,
    },
    {
      title: D.dashboardModificationListTitle,
      content: <ConceptsCreationsModifications conceptsData={conceptsData} type="modifications" />,
    },
  ];
