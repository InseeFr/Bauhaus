...
import GeneralEdition from "./components/general";
import { validate } from "./validation";
import CollectionMembersEdition from "./components/members";
...
class CollectionEditionCreation extends Component {
  ...
  render() {
    const { title, subtitle, collectionList, conceptList, submitting } = this.props;
    ...
    const errors = validate(general, collectionList, initialId, initialPrefLabelLg1);
