...
class ConceptEditionCreation extends Component {
  constructor(props) {
    super(props);
    const { general, notes, conceptsWithLinks, equivalentLinks = [], setSubmitting } = props;
    this.state = {
      id: this.props.id,
      showModal: false,
      data: {
    ...
    this.isVersioningPossible = () => isVersioningPossible(this.props.notes, this.state.data.notes);
  ...
  render() {
    const { stampList, maxLengthScopeNote, title, subtitle, creation, submitting } = this.props;
