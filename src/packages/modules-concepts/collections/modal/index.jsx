...
export const CollectionExportModal = ({ close, ids, exportOdt, exportOds }) => {
  ...
  const closeOdt = useCallback(() => {
    handleOdtExportCollectionListCallback(OPEN_DOCUMENT_TEXT_MIME_TYPE, lang, withConcepts);
    close();
  }, [close, handleOdtExportCollectionListCallback, lang, withConcepts]);

  const closeOds = useCallback(() => {
    handleOdsExportCollectionListCallback(OPEN_DOCUMENT_TEXT_MIME_TYPE, lang, withConcepts);
    close();
