...
import {
  SimsGeographyPicker,
  removeAccents,
  SimsGeographyPickerTypes,
} from "./SimsGeographyPicker";
...
const renderComponent = (props: Partial<SimsGeographyPickerTypes> = {}) => {
  const defaultProps = {
    onChange: vi.fn(),
    value: "",
...
describe("SimsGeographyPicker", () => {
  ...
  it("should disable SeeButton when value is not a Territoire Statistique", () => {
    ...
    const seeButton = container.querySelector<HTMLButtonElement>('button[aria-label="See"]');
    expect(seeButton).toBeTruthy();
