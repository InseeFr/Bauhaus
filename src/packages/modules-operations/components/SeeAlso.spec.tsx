...
describe("SeeAlso", () => {
  ...
  it("should display indicators", () => {
    const seeAlso = {
      indicator: [{ id: 1, label: "indicators" }] as unknown as OperationsLink[],
    };
  ...
  it("should display series", () => {
    const seeAlso = {
      series: [{ id: 1, label: "indicators" }] as unknown as OperationsLink[],
    };
    const { container } = renderWithRouter(<SeeAlso links={seeAlso} />);
  ...
  it("should display families", () => {
    const seeAlso = {
      family: [{ id: 1, label: "indicators" }] as unknown as OperationsLink[],
    };
    const { container } = renderWithRouter(<SeeAlso links={seeAlso} />);
  ...
  it("should display operations", () => {
    const seeAlso = {
      operation: [{ id: 1, label: "indicators" }] as unknown as OperationsLink[],
    };
    const { container } = renderWithRouter(<SeeAlso links={seeAlso} />);
