...
export const OutlineBlock = ({
  ...
  const [childrenDictionary, setChildrenDictionary] = useState<Record<string, any>>(
  ...
  const expandOrCollapseItem = ({ currentTarget: { id } }: MouseEvent<HTMLButtonElement>) => {
    toggleOpen(id);
