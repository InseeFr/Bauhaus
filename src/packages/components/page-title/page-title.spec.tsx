...
describe("page-title", () => {
  ...
  it("returns component title", () => {
    ...
    expect(container.querySelector(".wilco-page-title__title")!.innerHTML).toEqual("title");
  });

  it("returns component text", () => {
    const { container } = render(<PageTitle title="title" subtitle="subtitle" />);
    expect(container.querySelector(".wilco-page-title__title")!.innerHTML).toEqual(
