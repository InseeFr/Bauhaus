...
describe("CodeDisplay Component", () => {
  it("renders the correct label when a matching code is found", () => {
    ...
    const value = "code1";
    const { getByText } = render(<CodeDisplay codesList={codesList} value={value} />);
  ...
  it("renders nothing when no matching code is found", () => {
    ...
    const value = "code3";
    const { container } = render(<CodeDisplay codesList={codesList} value={value} />);
  ...
  it("renders nothing when codesList is undefined", () => {
    const value = "code1";
    const { container } = render(<CodeDisplay codesList={undefined as any} value={value} />);
    expect(container.innerHTML).toBe("");
  });
