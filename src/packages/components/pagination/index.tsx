...
const ariaLabel = (number?: number) => (number ? `${paginationD.goTo} ${number}` : "");
/**
        ...
        <div>
          <div className="col-md-3 pull-left wilco-pagination">
            <Select
              ...
              value={numberPerPageOptions.find(({ value }) => value === numberPerPage)}
            ...
            <ul className="wilco-pagination pull-right">
              ...
              <li>
                <Link
                  ...
                  to={`${pathnamePrefix}page=${pageNumbers.at(-1)}&perPage${numberPerPage}`}
                  disabled={isDisabled(currentPage + 1)}
                >
