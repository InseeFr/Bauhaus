    ...
    <div className="container editor-container">
      ...
      >
        ...
        <div className="form-group">
          ...
          <Select
            value={classificationsOptions.find((option) => option.value === value.general.idSeries)}
        ...
        <div className="form-group">
          ...
          <Select
            value={classificationsOptions.find((option) => option.value === value.general.idBefore)}
        ...
        <div className="form-group">
          ...
          <Select
            value={classificationsOptions.find((option) => option.value === value.general.idAfter)}
            options={classificationsOptions}
            onChange={(v) =>
              setValue({
                ...value,
        ...
        <div className="form-group">
          <label className="w-100">
            {D1.creatorTitle}
            <Select
              value={organisationsOptions.find((option) => option.value === value.general.creator)}
