...
describe("saveComponent", () => {
  const mockPutMutualizedComponent = StructureApi.putMutualizedComponent as Mock;
  const mockPostMutualizedComponent = StructureApi.postMutualizedComponent as Mock;
