...
interface StatisticalInformationTypes {
...
const StatisticalInformationTab = ({
  ...
  setEditingDataset,
  ...props
}: Readonly<StatisticalInformationTypes>) => {
      ...
      <Row>
        <TemporalField
          ...
          updateTemporalCoverage={(temporalCoverage) => {
            setEditingDataset({
              ...editingDataset,
              ...(temporalCoverage as unknown as Partial<Dataset>),
            });
          }}
        />
      </Row>
        ...
        <div className="col-md-12 from-group ">
          ...
          <NumberInput
            ...
            onChange={(e) => {
              setEditingDataset({
                ...editingDataset,
                observationNumber: e.target.value as unknown as number,
              });
            }}
          />
        </div>
        ...
        <div className="col-md-12 from-group ">
          ...
          <NumberInput
            ...
            onChange={(e) => {
              setEditingDataset({
                ...editingDataset,
                timeSeriesNumber: e.target.value as unknown as number,
              });
            }}
          />
        </div>
