...
Pour les besoins de déploiement à l'INSEE, la CI devra utiliser la commande `yarn build`. Cette commande va également créer une archive (zip) content le projet afin de le déployer. 
